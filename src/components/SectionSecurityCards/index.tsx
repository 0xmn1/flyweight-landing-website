...
const SectionSecurityCards = () => (
  <>
    ...
    <SectionSecurityCard icon={<FileEarmarkLock />}>
      There is <strong>no DAO</strong>, thus eliminating the possibility of unfair governance proposals that redirect treasury resources or unreasonable protocol changes for ill gain.
    </SectionSecurityCard>
    <SectionSecurityCard icon={<Github />}>
      100% of flyweight is <strong>open source</strong> under the very open/welcome MIT license. Any developer can fork the repos &amp; run it locally, or even launch their own new version of Flyweight.
    </SectionSecurityCard>
