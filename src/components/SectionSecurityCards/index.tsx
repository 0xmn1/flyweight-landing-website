...
const SectionSecurityCards = () => (
  <>
    <SectionSecurityCard icon={<ChevronDown />}>
    ...
    <SectionSecurityCard icon={<ChevronDown />}>
      Contracts are <a href="https://goerli.etherscan.io/address/0xc7A45A1d083DaB3F0b8AdfdE9Bab4f8996851Ff0#code" target="_blank" title="Opens etherscan in a new tab">verified on Etherscan</a>.
    </SectionSecurityCard>
  </>
);
